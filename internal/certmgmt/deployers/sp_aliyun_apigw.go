...
import (
	...
	dplyimpl "github.com/certimate-go/certimate/pkg/core/deployer/providers/aliyun-apigw"
	xmaps "github.com/certimate-go/certimate/pkg/utils/maps"
)

func init() {
	Registries.MustRegister(domain.DeploymentProviderTypeAliyunAPIGW, func(options *ProviderFactoryOptions) (core.Deployer, error) {
