  ...
  return (
    <>
      <Form.Item
        ...
        label={t("workflow_node.deploy.form.huaweicloud_apig_region.label")}
        rules={[formRule]}
        tooltip={<span dangerouslySetInnerHTML={{ __html: t("workflow_node.deploy.form.huaweicloud_apig_region.tooltip") }}></span>}
      >
        <Input placeholder={t("workflow_node.deploy.form.huaweicloud_apig_region.placeholder")} />
      </Form.Item>
      ...
      <Show when={fieldResourceType === RESOURCE_TYPE_CERTIFICATE}>
        <Form.Item
          ...
          label={t("workflow_node.deploy.form.huaweicloud_apig_certificate_id.label")}
          rules={[formRule]}
          tooltip={<span dangerouslySetInnerHTML={{ __html: t("workflow_node.deploy.form.huaweicloud_apig_certificate_id.tooltip") }}></span>}
        >
          <Input placeholder={t("workflow_node.deploy.form.huaweicloud_apig_certificate_id.placeholder")} />
        </Form.Item>
      </Show>
    </>
  );
...
const _default = Object.assign(BizDeployNodeConfigFieldsProviderHuaweiCloudAPIG, {
  getInitialValues,
  getSchema,
});
