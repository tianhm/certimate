...
const BizDeployNodeConfigFieldsProviderBytePlusMediaLive = () => {
    ...
    <>
      ...
      <Show when={fieldDomainMatchPattern !== DOMAIN_MATCH_PATTERN_CERTSAN}>
        <Form.Item
          ...
          label={t("workflow_node.deploy.form.byteplus_medialive_domain.label")}
          rules={[formRule]}
        >
          <Input placeholder={t("workflow_node.deploy.form.byteplus_medialive_domain.placeholder")} />
        </Form.Item>
      </Show>
    </>
  );
...
const _default = Object.assign(BizDeployNodeConfigFieldsProviderBytePlusMediaLive, {
  getInitialValues,
  getSchema,
});
