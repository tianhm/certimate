...
import (
	...
	aliyunoss "github.com/certimate-go/certimate/pkg/core/ssl-deployer/providers/aliyun-oss"
	xmaps "github.com/certimate-go/certimate/pkg/utils/maps"
)

func init() {
	Registries.MustRegister(domain.DeploymentProviderTypeAliyunOSS, func(options *ProviderFactoryOptions) (core.SSLDeployer, error) {
