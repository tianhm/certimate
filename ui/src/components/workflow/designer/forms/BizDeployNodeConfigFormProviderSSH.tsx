...
import { initPresetScript as _initPresetScript } from "./BizDeployNodeConfigFormProviderLocal";
...
const BizDeployNodeConfigFormProviderSSH = () => {
...
const _default = Object.assign(BizDeployNodeConfigFormProviderSSH, {
  getInitialValues,
  getSchema,
});
