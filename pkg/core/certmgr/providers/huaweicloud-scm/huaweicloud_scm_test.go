...
import (
	...
	provider "github.com/certimate-go/certimate/pkg/core/certmgr/providers/huaweicloud-scm"
)
...
Shell command to run this test:
	...
	--HUAWEICLOUDSCM_INPUTCERTPATH="/path/to/your-input-cert.pem" \
	--HUAWEICLOUDSCM_INPUTKEYPATH="/path/to/your-input-key.pem" \
