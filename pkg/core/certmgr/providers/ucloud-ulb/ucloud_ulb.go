...
import (
	...
	ucloudlb "github.com/certimate-go/certimate/pkg/sdk3rd/ucloud/ulb"
...
func createSDKClient(privateKey, publicKey string) (*ucloudlb.ULBClient, error) {
	...
	client := ucloudlb.NewClient(&cfg, &credential)
	return client, nil
}
