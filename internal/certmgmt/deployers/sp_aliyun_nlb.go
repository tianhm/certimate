...
import (
	...
	dplyimpl "github.com/certimate-go/certimate/pkg/core/deployer/providers/aliyun-nlb"
	xmaps "github.com/certimate-go/certimate/pkg/utils/maps"
)

func init() {
	Registries.MustRegister(domain.DeploymentProviderTypeAliyunNLB, func(options *ProviderFactoryOptions) (core.Deployer, error) {
