...
import (
	...
	provider "github.com/certimate-go/certimate/pkg/core/certmgr/providers/aws-acm"
)
...
Shell command to run this test:
	...
	--AWSACM_INPUTCERTPATH="/path/to/your-input-cert.pem" \
	--AWSACM_INPUTKEYPATH="/path/to/your-input-key.pem" \
