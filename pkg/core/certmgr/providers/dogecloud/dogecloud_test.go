...
import (
	...
	provider "github.com/certimate-go/certimate/pkg/core/certmgr/providers/dogecloud"
)
...
Shell command to run this test:
	...
	--DOGECLOUD_INPUTCERTPATH="/path/to/your-input-cert.pem" \
	--DOGECLOUD_INPUTKEYPATH="/path/to/your-input-key.pem" \
