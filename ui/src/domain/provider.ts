...
export const deploymentProvidersMap: Map<DeploymentProvider["type"] | string, DeploymentProvider> = new Map(
  ...
  (
    [
      ...
      [DEPLOYMENT_PROVIDERS.ALIYUN_DDOSPRO, "provider.aliyun.ddospro", DEPLOYMENT_CATEGORIES.FIREWALL],
      ...
      [DEPLOYMENT_PROVIDERS.HUAWEICLOUD_OBS, "provider.huaweicloud.obs", DEPLOYMENT_CATEGORIES.STORAGE],
      ...
      [DEPLOYMENT_PROVIDERS.BAOTAPANELGO_SITE, "provider.baotapanelgo.site", DEPLOYMENT_CATEGORIES.WEBSITE],
      [DEPLOYMENT_PROVIDERS.BAOTAPANELGO_CONSOLE, "provider.baotapanelgo.console", DEPLOYMENT_CATEGORIES.OTHER],
      ...
      [DEPLOYMENT_PROVIDERS.SAFELINE_SITE, "provider.safeline.site", DEPLOYMENT_CATEGORIES.FIREWALL],
