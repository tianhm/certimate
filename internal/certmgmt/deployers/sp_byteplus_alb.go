...
import (
	...
	dplyimpl "github.com/certimate-go/certimate/pkg/core/deployer/providers/byteplus-alb"
	xmaps "github.com/certimate-go/certimate/pkg/utils/maps"
)

func init() {
	Registries.MustRegister(domain.DeploymentProviderTypeBytePlusALB, func(options *ProviderFactoryOptions) (core.Deployer, error) {
