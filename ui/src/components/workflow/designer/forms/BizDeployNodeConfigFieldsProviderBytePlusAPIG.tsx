...
const BizDeployNodeConfigFieldsProviderBytePlusAPIG = () => {
  ...
  return (
    <>
      <Form.Item
        ...
        label={t("workflow_node.deploy.form.byteplus_apig_region.label")}
        rules={[formRule]}
        tooltip={<span dangerouslySetInnerHTML={{ __html: t("workflow_node.deploy.form.byteplus_apig_region.tooltip") }}></span>}
      >
        <Input placeholder={t("workflow_node.deploy.form.byteplus_apig_region.placeholder")} />
      </Form.Item>
      ...
      <Show when={fieldDomainMatchPattern !== DOMAIN_MATCH_PATTERN_CERTSAN}>
        <Form.Item
          ...
          label={t("workflow_node.deploy.form.byteplus_apig_domain.label")}
          rules={[formRule]}
        >
          <Input placeholder={t("workflow_node.deploy.form.byteplus_apig_domain.placeholder")} />
        </Form.Item>
      </Show>
    </>
  );
...
const _default = Object.assign(BizDeployNodeConfigFieldsProviderBytePlusAPIG, {
  getInitialValues,
  getSchema,
});
